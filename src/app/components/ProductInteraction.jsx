...
const ProductInteraction = ({ products, selectedColor, selectedSize }) => {
   ...
   const handleAddToCart = () => {
    dispatch(
      addToCart({
        ...
        size: selectedSize,
        color: selectedColor,
        image: products.images[selectedColor], 
      })
    );
  ...
  return (
    <div className="flex flex-col gap-4 mt-4">
      ...
      <button
        ...
        className="bg-gray-800 text-white px-4 py-2 mt-5 rounded-md shadow-lg flex items-center justify-center gap-2 cursor-pointer text-sm font-medium"
      >
        <Plus className="w-4 h-4" />
        Add to Cart
      </button>
